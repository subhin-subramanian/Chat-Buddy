...
import { BellIcon, CircleUserRound, HomeIcon, MessagesSquare, Power, Users} from "lucide-react"
...
function SideBar() {
  ...
  return (
    ...
    <aside className="hidden md:flex flex-col min-w-64 w-64 bg-base-200 border-r border-base-300 h-full sticky top-0">
